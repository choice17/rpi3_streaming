...
def run():
    ...
    while (1):
        ...
        try:
            ...
            print "gyroscope_xout(Roll) : ", ("%5d" % gyroscope_xout), " norm: ", (gyroscope_xout / 131)
            print "gyroscope_yout(Pitch): ", ("%5d" % gyroscope_yout), " norm: ", (gyroscope_yout / 131)
            print "gyroscope_zout(Yaw)  : ", ("%5d" % gyroscope_zout), " norm: ", (gyroscope_zout / 131)
